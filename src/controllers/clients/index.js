...
import _getRegister from './get.register';
import _postRegister from './post.register';
import _getLogout from './get.logout';
import _getLogin from './get.login';
import _postLogin from './post.login';
...
export const getLogout = _getLogout;
export const getLogin = _getLogin;
